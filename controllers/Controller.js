  ...
  static collectRequestParams(request) {
    ...
    if (request.openapi.schema.requestBody !== undefined) {
      ...
      if (content['application/json'] !== undefined) {
        ...
        if (schema.$ref) {
          requestParams[camelCase.default(schema.$ref.substr(schema.$ref.lastIndexOf('/')+1))] = request.body;
    ...
    requestParams['ip_address'] = request.headers['x-forwarded-for'] || request.connection.remoteAddress || request.socket.remoteAddress;
